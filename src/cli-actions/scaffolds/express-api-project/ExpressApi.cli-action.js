...
class ExpressApiProjectCli extends CliModule {
			...
			.action(function (args, callback) {
				...
				this.prompt([
					...
					},
					{
						type: 'input',
						name: 'apiWebsite',
						message: 'What is the website associated with this API?',
						default: 'monstermakes.tech'
					}
				]).then(answers => {
...
module.exports = ExpressApiProjectCli;